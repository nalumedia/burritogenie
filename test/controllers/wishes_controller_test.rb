...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { wish_address: @wish.wish_address, wish_instructions: @wish.wish_instructions, wish_phone: @wish.wish_phone, wish_zip: @wish.wish_zip }
    end
  ...
  test "should update wish" do
    patch :update, id: @wish, wish: { wish_address: @wish.wish_address, wish_instructions: @wish.wish_instructions, wish_phone: @wish.wish_phone, wish_zip: @wish.wish_zip }
    assert_redirected_to wish_path(assigns(:wish))
  end
